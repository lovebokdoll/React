...
class AuthLogic {
  ...
  //생성자 - 전역변수 초기화
  constructor() {
    this.auth = getAuth(); //firebase developer console신청한 프로젝트 설정정보 확인
    this.googleProvider = new GoogleAuthProvider(); //구글인증 , 카카오인증..
...
// 콜백함수
export default AuthLogic; //외부에서 js사용할 때
